      ...
      <div className="footer-container">
        ...
        <div className="ft-list">
          ...
          <ul className="ft-list-items">
            <li>
              <a href="#services">Academic Emergency Support</a>
            </li>
            <li>
              <a href="#services">Academic Outline (Curriculum Plans)</a>
            </li>
            <li>
              <a href="#services">Insights for Educators</a>
            </li>
            <li>
              <a href="#services">Accouncements</a>
            </li>
            <li>
              <a href="#services">Achievement</a>
            </li>
          </ul>
        </div>
        ...
        <div className="ft-list">
          ...
          <ul className="ft-list-items">
            ...
            <li>
              <Link to={"/legal"}>Terms of Academic </Link>
            </li>
         
            <li>
              <Link to={"/legal"}>Reach Out to Us</Link>
            </li>
            <li>
              <Link to={"/legal"}>Academic Calendar</Link>
            </li>
          </ul>
        </div>
